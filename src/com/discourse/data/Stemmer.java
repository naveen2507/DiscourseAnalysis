...
class Stemmer {
	...
	public String getStemmedSentence(String tweet){
		char[] w = new char[501];
		//Stemmer s = this.
		StringBuffer stemWord  = new StringBuffer();
		Scanner reader = new Scanner(tweet);
	...
	public static void main(String[] args) throws IOException {
		...
		String se = s.getStemmedSentence("acting action");
...
//		// FileInputStream("D:\\Uni-MS\\Discourse\\my_paper\\twitter-data\\Manually-Annotated-Tweets.tsv");
//
//		String senten = "Taking my daughter to the cinema for the first time, 'film' is tinkerbell rather than citizen Kane/shawshank redemption, but it's a start!";
//		Scanner reader = new Scanner(senten);
//		while(reader.hasNext()){
//			String nodes = reader.next();
//			w = nodes.toCharArray();
//			for(int i = 0; i < nodes.length(); i++) {
